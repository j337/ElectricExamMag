      ...
      public ActionResult GetData()
        {
            ...
            if (role.roleName == "系统管理员" || role.roleName == "线路管理员")
            {
                var flawlist = (from a in medc.ps_inspectiontask_main
                                ...
                                where b.isSolve == 1 && b.isBug == 1 && b.taskStatus == 4
            ...
            else
            {
                var flawlist = (from a in medc.ps_inspectiontask_main
                                ...
                                where b.isSolve == 1 && b.isBug == 1 && b.taskStatus == 4&&c.inspectorCode==user.userCode
                                select new { taskcode = a.inspectionTaskCode, linecode = a.lineCode, polecode = b.poleCode, buglevelname = b.bugLevelName, bugtypename = b.bugTypeName, discovername = b.discovererName, discovertime = b.discoverTime, issuedname = a.issuedByName, issuedtime = a.issuedTime, intactrate = b.intactRate, bugdesc = b.bugDesc }).ToList();
        ...
        public ActionResult SelectData()
        {
            ...
            if (role.roleName == "系统管理员" || role.roleName == "线路管理员")
            {
                sql = "select a.inspectionTaskCode,b.lineCode,b.polecode,b.bugLevelName,b.bugTypeName,b.discovererName,b.discoverTime,a.issuedByName,a.issuedTime,b.intactRate,b.bugDesc from ps_inspectiontask_main a,ps_inspectiontask_detail b  where a.id=b.taskid and b.isSolve=1 and b.isBug=1 and a.taskStatus=4 ";
            }
            else
            {
                sql = "select a.inspectionTaskCode,b.lineCode,b.polecode,b.bugLevelName,b.bugTypeName,b.discovererName,b.discoverTime,a.issuedByName,a.issuedTime,b.intactRate,b.bugDesc from ps_inspectiontask_main a inner join  ps_inspectiontask_detail b on a.id=b.taskid inner join ps_inspector_detail c on a.id=c.taskid  where b.isSolve=1 and b.isBug=1 and a.taskStatus=4 and c.inspectorCode='"+user.userCode+"' ";
            }
            ...
            if (Request.Params["ptime3"] != "")
            {
                ...
                sql += " and b.discoverTime>= '" + time3 + "' and b.discoverTime<='" + time4 + "'";
            }
